  ...
  return (
      <div className="w-full bg-[#F1F1EE] py-8 px-4 sm:px-8 flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-[44px]">
        ...
        <img
            src="/join_senior.svg"
            alt="join senior"
            className="w-1/2 max-w-30 sm:max-w-lg lg:max-w-[406px] max-h-sm object-contain"
        />

        {/* Text Content */}
        <div className="w-full max-w-3xl flex flex-col text-black text-center sm:text-left">
          <h3 className="text-xl sm:text-2xl lg:text-[24px] font-bold text-[#474F56] mb-4 leading-snug">
            職屬：攜手踏上屬於人文專長人才的職涯探險
          </h3>

          <p className="text-sm sm:text-base text-[#5F6368] leading-relaxed space-y-2">
          <span>
