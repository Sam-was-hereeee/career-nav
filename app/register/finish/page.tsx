...
const AboutPage = () => {
    ...
    return (
        <div>
            ...
            <div className={"w-2/3 px-10 mx-auto flex flex-col items-center justify-center mt-8"}>
                ...
                <div className={"w-full flex flex-row items-center justify-center mt-8"}>
                    <img src={'/happy.svg'} alt={'thank you'} className={"py-4 mx-auto contain-content w-60"}></img>
                    <p className={"whitespace-pre inline text-center text-xl"}>{"我們相信，每段職涯經驗都是值得分享的故事。\n" +
